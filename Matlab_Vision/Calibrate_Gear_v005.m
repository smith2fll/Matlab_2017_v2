...
for img=1:3
    ...
    if img == 1
        final_H_treshold = H_treshold;
        final_S_treshold = S_treshold;
        final_L_treshold = L_treshold;
    else
        final_H_treshold(1) = min(final_H_treshold(1), H_treshold(1))
        final_H_treshold(2) = max(final_H_treshold(2), H_treshold(2));
        final_S_treshold(1) = min(final_S_treshold(1), S_treshold(1))
        final_S_treshold(2) = max(final_S_treshold(2), S_treshold(2));
        final_L_treshold(1) = min(final_L_treshold(1), L_treshold(1))
        final_L_treshold(2) = max(final_L_treshold(2), L_treshold(2));
    end
end
