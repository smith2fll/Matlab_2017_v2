...
%%--------------------------------------------------------------------------
%
%   Trajectory Type : From Starting Position RS3 to Peg RP3
%
...
P1_y        = P0_y;
P2_y        = P0_y + del_y2;           % NOTE! Sign change compared to RS1 to RP1
...
C2_x			= P1_x;
C2_y			= (P1_y + arcR);           % NOTE! Sign change compared to RS1 to RP1
...
sweep_angle_t2	= all_theta_t2+90*deg;           % NOTE! Sign change compared to RS1 to RP1
