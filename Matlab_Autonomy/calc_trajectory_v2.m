function [Ctheta, Cx, Cy] = calc_trajectory_v2(x0,y0,theta0,xf,yf,thetaf,vx0,vy0,omega0,vxf,vyf,omegaf,tfinal, d)
%
...
%
%   where C = [ Cth3 Cth2 Cth1 Cth0 Cx3 Cx2 Cx1 Cx0]'
%
%   Start with 3rd order polynomial for x
%   and 3rd order polynomial for theta
...
M          = [ ...
    0       0       0       0       0       0       0       1       ; ...       % for x0
    0       0       0       0       t3      t2      t       1       ; ...       % for xf
    0       0       0       0       0       0       1       0       ; ...       % for vx0
    0       0       0       0       3*t2    2*t     1       0       ; ...       % for vxf
    0       0       0       1       0       0       0       0       ; ...       % for theta0
    t3      t2      t       1       0       0       0       0       ; ...       % for thetaf
    0       0       1       0       0       0       0       0       ; ...       % for omega0
    3*t2    2*t     1       0       0       0       0       0       ; ...       % for omegaf
    ];
...
M2          = [ ...
    0       0       0       0       0       0       0       1       ; ...       % for y0
    0       0       0       0       t3      t2      t       1       ; ...       % for yf
    0       0       0       0       0       0       1       0       ; ...       % for vy0
    0       0       0       0       3*t2    2*t     1       0       ; ...       % for vyf
    0       0       0       1       0       0       0       0       ; ...       % for theta0
    t3      t2      t       1       0       0       0       0       ; ...       % for thetaf
    0       0       1       0       0       0       0       0       ; ...       % for omega0
    3*t2    2*t     1       0       0       0       0       0       ; ...       % for omegaf
